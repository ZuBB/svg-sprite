...
import { ArgumentError, NotPermittedError } from './errors.mjs';
import calculateSvgDimensions from './utils/calculate-svg-dimensions.mjs';
import fixXMLString from './utils/fix-xml-string.mjs';
...
SVGShape.prototype._determineDimensions = function(cb) {
  ...
  if (!this.width || !this.height) {
    ...
    // TODO: figure out about lazy loading
    // const calculateSvgDimensions = require('./utils/calculate-svg-dimensions.mjs');
 ...
 */
export default function createSVGShapeInstance(file, spriter) {
